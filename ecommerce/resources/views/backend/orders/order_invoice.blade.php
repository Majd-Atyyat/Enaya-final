  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Enaya</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Enaya Shop
               Email:majdatyyat@gmail.com <br>
               Mob: 00962775252251<br>
               Amman, Jordan<br>
...
<h3>Products</h3>
    ...
    <tbody>
     ...
     @foreach($orderItem as $item)
      <tr class="font">
        ...
        <td align="center">{{ $item->price }} JOD</td>
        <td align="center">{{ $item->price * $item->qty }} JOD </td>
      </tr>
      @endforeach
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: green;">Subtotal:</span>{{ $order->amount }} JOD</h2>
            <h2><span style="color: green;">Total:</span> {{ $order->amount }} JOD</h2>

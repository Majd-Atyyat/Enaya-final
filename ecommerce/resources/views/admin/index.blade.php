...
<div class="container-full">
		...
		<div>
			...
			<h3 class="text-white mb-0 font-weight-500">{{ $today  }} JOD <small class="text-success"> </small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			...
			<h3 class="text-white mb-0 font-weight-500">{{ $month }} JOD <small class="text-success"> </small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			...
			<h3 class="text-white mb-0 font-weight-500">{{ $year }} JOD <small class="text-danger"></small></h3>
		</div>
	</div>
</div>
</div>
...
<div class="box overflow-hidden pull-up">
	<div class="box-body">							
		...
		<div>
			...
			<h3 class="text-white mb-0 font-weight-500">{{ count($pending) }} Orders <small class="text-danger"> </small></h3>
		</div>
	</div>
</div>
</div>
